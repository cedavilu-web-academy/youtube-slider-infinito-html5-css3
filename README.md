<h1>Código para la construcción de un slider infinito.</h1>
...
Listo ya tienes la carpeta con todo el código para que puedas repasar todo lo que hago en el video.
